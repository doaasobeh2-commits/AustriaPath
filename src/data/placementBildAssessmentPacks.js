...
export const placementBildAssessmentPacks = Object.freeze([
  ...
  pack("A2", 10, "Küche und Salat",
    ...
    [E("place", ["küche"], undefined, 1), E("salad_action", ["salat", "schneid", "gemüse"], ["macht.*salat", "bereitet.*salat", "schneidet.*gemüse"], 1), E("vegetables", ["gemüse", "tomate", "gurke", "paprika"], ["tomate", "gurke", "paprika"], 2), E("healthy", ["gesund"], undefined, 3), E("cooking_preference", ["koche gern", "kochen gern", "mag kochen"], undefined, 3), E("cooking_detail", ["ich koche.*gern", "koche gern.*suppe", "koche gern.*reis", "koche gern.*salat"], undefined, 4)],
